    ...
    return (
        <AppLayout>
            ...
            <div className="max-w-4xl">
                <p className="eyebrow">Workspace signals</p>
                <h1 className="page-title">Notifications &amp; attention</h1>
                <p className="page-subtitle">
                    Current operational items that need a follow-up. The list is permission-aware and comes from the
                    live workspace queue.
                </p>
                ...
                <div className="card mt-8 overflow-hidden">
                    {attentionQueue.length === 0 ? (
                        <div className="px-6 py-14 text-center">
                            ...
                            <h2 className="mt-4 section-title">You are all caught up</h2>
                            <p className="mt-2 text-sm text-muted">There are no current notifications for your role.</p>
                        </div>
                    ) : (
