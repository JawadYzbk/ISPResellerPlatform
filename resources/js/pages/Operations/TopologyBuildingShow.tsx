...
function BoxCard({
    ...
    const assign = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        assignmentForm.post(`/operations/topology/services/${assignmentForm.data.service_id}/assignment`, {
            preserveScroll: true,
                ...
                {canManage && (
                    <form onSubmit={save} className="space-y-4 rounded-xl bg-sand/40 p-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <label>
                                ...
                                <ResponsiveSelect
                                    ...
                                    onChange={(event) => editForm.setData('box_type', event.target.value)}
                                >
                                    {boxTypes.map((type) => (
                            ...
                            <label>
                                ...
                                <input
                                    ...
                                    min="1"
                                    className="field"
                                    value={editForm.data.capacity_ports}
                                    onChange={(event) => editForm.setData('capacity_ports', event.target.value)}
                                />
                            ...
                            <label>
                                ...
                                <ErrorText message={editForm.errors.status} />
                            </label>
                        </div>
                        ...
                        <label>
                            ...
                            />
                            <ErrorText message={editForm.errors.notes} />
                        </label>
                ...
                {canManage && (
                    ...
                    >
                        <label>
                            ...
                            <ErrorText
                                message={
                                    assignmentForm.errors.service_id ||
                                    (assignmentForm.errors as Record<string, string | undefined>).topology
                                }
                            />
                        </label>
                        <label>
                            ...
                            <input
                                type="number"
                                min="1"
                                max={box.capacity_ports}
                                className="field"
                                value={assignmentForm.data.network_port}
                                onChange={(event) => assignmentForm.setData('network_port', event.target.value)}
                                placeholder="1"
                            />
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {canManage && (
                                    <ConfirmDialog
                                        ...
                                        onConfirm={() =>
                                            router.delete(
                                                `/operations/topology/services/${service.public_id}/assignment`,
                                                { preserveScroll: true },
                                            )
                                        }
                                    >
...
export default function TopologyBuildingShowPage({
    building,
    services,
    pops,
    canManage,
    ...
    const buildingForm = useForm<FormValues>({
        ...
        unit_count: building.unit_count === null ? '' : String(building.unit_count),
    ...
    const boxForm = useForm<BoxFormValues>({
        ...
        notes: '',
        pop_id: '',
        box_type: boxTypes[0] ?? 'distribution',
        capacity_ports: '8',
    });
    ...
    const createBox = (event: React.FormEvent<HTMLFormElement>) => {
        event.preventDefault();
        boxForm.post(`/operations/topology/buildings/${building.public_id}/boxes`, {
            preserveScroll: true,
            onSuccess: () =>
                boxForm.reset(
                    'name',
    ...
    return (
        <AppLayout>
                    ...
                    <span className="tabular-nums">
                        {
                            services.filter(
                                (service) =>
                                    service.distribution_box?.public_id &&
            ...
            {canManage && (
                <form onSubmit={updateBuilding} className="card mt-8 space-y-5 p-6">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <label>
                            ...
                            <input
                                ...
                                onChange={(event) => buildingForm.setData('name', event.target.value)}
                            />
                        ...
                        <label>
                            ...
                            <input
                                ...
                                onChange={(event) => buildingForm.setData('code', event.target.value)}
                            />
                        ...
                        <label className="md:col-span-2">
                            ...
                            <input
                                ...
                                onChange={(event) => buildingForm.setData('address', event.target.value)}
                            />
                        ...
                        <label>
                            ...
                            <input
                                ...
                                min="0"
                                className="field"
                                value={buildingForm.data.floors}
                                onChange={(event) => buildingForm.setData('floors', event.target.value)}
                            />
                        ...
                        <label>
                            ...
                            <input
                                ...
                                min="0"
                                className="field"
                                value={buildingForm.data.unit_count}
                                onChange={(event) => buildingForm.setData('unit_count', event.target.value)}
                            />
                        ...
                        <label>
                            ...
                            <ResponsiveSelect
                                ...
                                onChange={(event) => buildingForm.setData('status', event.target.value)}
                            >
                            ...
                            <ErrorText message={buildingForm.errors.status} />
                        </label>
                    </div>
                    <CustomerLocationFields
                    ...
                    <label>
                        ...
                        <textarea
                            ...
                            onChange={(event) => buildingForm.setData('notes', event.target.value)}
                        />
                        <ErrorText message={buildingForm.errors.notes} />
                    </label>
                    <div className="flex justify-end">
            ...
            {canManage && (
                <form onSubmit={createBox} className="card mt-8 space-y-5 p-6">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <label>
                            ...
                            <input
                                ...
                                onChange={(event) => boxForm.setData('code', event.target.value)}
                                placeholder="CEDAR-CAB-01"
                            />
                        ...
                        <label>
                            ...
                            <ResponsiveSelect
                                ...
                                onChange={(event) => boxForm.setData('box_type', event.target.value)}
                            >
                                {boxTypes.map((type) => (
                                    <option key={type} value={type}>
                                        {t(type.replace('_', ' '))}
                        ...
                        <label>
                            ...
                            <input
                                ...
                                min="1"
                                className="field"
                                value={boxForm.data.capacity_ports}
                                onChange={(event) => boxForm.setData('capacity_ports', event.target.value)}
                            />
                        ...
                        <label>
                            ...
                            <ErrorText message={boxForm.errors.pop_id} />
                        </label>
                    </div>
                    <CustomerLocationFields
