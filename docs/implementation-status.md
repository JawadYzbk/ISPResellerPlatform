...
| ISP-022/023/024 | Versioned plan prices, tenant-safe plan catalog/create workflow, addon and promotion CRUD, router rate-limit preview, customer creation/phone normalization, service transitions and billing-period arithmetic | delivered for current catalog scope |
| ISP-030/031/032/033 | Historical FX with capability-gated effective-dated rate administration, append-only double-entry ledger, invoice lifecycle, append-only credit notes, idempotent payments and reversals, staff invoice/payment queues, tenant-safe invoice/receipt details, browser print layouts, invoice-balance validation and recent-auth reversal controls | delivered for current billing scope; server PDF engine remains |
| ISP-034/035/036 | Payment renewal, current-cashier cash-shift reconciliation with variance controls, manager-level daily collector totals, and scheduled tenant-aware idempotent billing runs | delivered for current billing scope |
