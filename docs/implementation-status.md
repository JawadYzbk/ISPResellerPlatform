...
| ISP-060/061/062 | Ticket lifecycle, tenant-timezone business-hours SLA clock, scheduled resolved-ticket auto-close, tenant-safe staff ticket queue/detail/reply/status/assignment workflow, public versus internal message visibility, customer portal ticket messages, work-order queue/detail/history/checklist/completion/rescheduling, assigned work-order media evidence upload/detail/download, and serialized inventory assignment | delivered for current ticket/work-order scope; calendar, signature capture and material consumption remain |
...
| ISP-073 | Technician-assigned work-order list/detail endpoints, tenant-safe staff work-order completion surface, idempotent completion, assigned work-order evidence upload/detail response, private operator download, service diagnostics and serialized inventory operations/assignment view | delivered for current technician scope |
