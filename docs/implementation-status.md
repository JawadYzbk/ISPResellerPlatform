...
| ISP-060/061/062 | Ticket lifecycle, tenant-timezone business-hours SLA clock, scheduled resolved-ticket auto-close, tenant-safe staff ticket queue/detail/reply/status/assignment workflow, public versus internal message visibility, customer portal ticket messages, work-order queue/detail/history/checklist/completion/rescheduling/calendar, assigned work-order media evidence, signature capture, technician readings, bulk-material consumption, serialized inventory assignment, and serialized-equipment return on service termination | delivered for current ticket/work-order scope; broader inventory transfer/recovery workflows remain |
