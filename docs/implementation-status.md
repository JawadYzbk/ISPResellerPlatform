...
| ISP-060/061/062 | Ticket lifecycle, tenant-timezone business-hours SLA clock, scheduled resolved-ticket auto-close, tenant-safe staff ticket queue/detail/reply/status/assignment workflow, public versus internal message visibility, customer portal ticket messages, work-order queue/detail/history/checklist/completion/rescheduling/calendar, assigned work-order media evidence, signature capture, technician readings, bulk-material consumption, and serialized inventory assignment | delivered for current ticket/work-order scope; stock returns on disconnection and broader inventory movement workflows remain |
