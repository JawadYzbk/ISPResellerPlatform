...
| ISP-030/031/032/033 | Historical FX with capability-gated effective-dated rate administration, append-only double-entry ledger, invoice lifecycle, append-only credit notes, idempotent payments and reversals, staff invoice/payment queues, tenant-safe invoice/receipt details, A4 invoice/receipt PDF downloads with RTL document direction, browser print layouts, invoice-balance validation and recent-auth reversal controls | delivered for current billing scope |
