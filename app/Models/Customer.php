...
class Customer extends Model
{
    ...
    protected function casts(): array { return ['status' => CustomerStatus::class, 'balance_amount' => 'integer']; }

    protected static function booted(): void
    {
        static::creating(function (self $customer): void { $customer->public_id ??= (string) Str::ulid(); });
    }
