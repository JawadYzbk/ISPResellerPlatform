...
- Staff ticket conversation/status workflow, customer support history, work-order completion surface, serialized inventory trace, and plan catalog/create workflow
